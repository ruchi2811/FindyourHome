...
public class VerifyPhoneNumber extends AppCompatActivity {
    ...
    private void sendVerificationCode(String mobile) {
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                mCallbacks);
        Toast.makeText(VerifyPhoneNumber.this , "Send verification code",Toast.LENGTH_LONG).show();
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
            ...
            if (code != null) {
                ...
                Toast.makeText(VerifyPhoneNumber.this , "Code not null",Toast.LENGTH_LONG).show();
                ...
                .addOnCompleteListener(VerifyPhoneNumber.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(VerifyPhoneNumber.this, payment.class);
                            Toast.makeText(VerifyPhoneNumber.this , "Payment through Paytm",Toast.LENGTH_LONG).show();
